...
let singletonNonceSubProvider = new NonceSubProvider();
...
function HDWalletProvider(
  ...
  for (let i = address_index; i < address_index + num_addresses; i++) {
    let wallet = this.hdwallet.derivePath(this.wallet_hdpath + i).getWallet();
  ...
  this.engine.addProvider(
    new ProviderSubprovider(new Web3.providers.HttpProvider(provider_url))
  );
